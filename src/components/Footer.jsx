  ...
  return (
    <footer className="mt-12 border-t border-sky-900/50 bg-gradient-to-r from-slate-950 via-sky-950 to-slate-950 text-slate-200">
      <div className="mx-auto max-w-6xl px-4 py-10">
        <div className="grid gap-8 md:grid-cols-[1fr_auto_auto] md:items-start md:gap-12">
          <div>
            ...
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-slate-300">Soluções em engenharia e infraestrutura com foco em qualidade, segurança e desempenho em cada entrega.</p>
          </div>

          <div className="md:justify-self-center">
            <h4 className="text-lg font-semibold text-white">Navegação</h4>
            <ul className="mt-3 grid grid-cols-2 gap-x-6 gap-y-2 text-sm text-slate-300">
